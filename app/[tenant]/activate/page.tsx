...
function ActivateContent() {
  ...
  const [phase, setPhase] = useState<
    "validating" | "form" | "success" | "error" | "start"
  >("validating");
    ...
    return (
      <div className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="z-10 text-center">
          <Loader2
            className="w-10 h-10 animate-spin mx-auto mb-3 opacity-60"
  ...
  if (phase === "start") {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 relative">
        {bg}
        <div className="z-10 glass p-8 sm:p-10 rounded-[32px] max-w-md w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              To activate your account, please click the{" "}
              <strong>secure link</strong> sent to your email address by your
              institution.
            </p>
          </div>
          <div className="pt-4 border-t border-border/40">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-muted text-white font-bold hover:bg-muted/80 transition-all"
            >
              Back to Login
            </button>
          </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="z-10 glass p-8 sm:p-10 rounded-[28px] max-w-md w-full shadow-2xl">
        ...
        <div className="text-center mb-8">
          <div
            className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 text-white font-black text-2xl"
        ...
        <form onSubmit={handleActivate} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full justify-center !py-3.5 mt-2 shadow-xl"
          >
            {loading ? (
