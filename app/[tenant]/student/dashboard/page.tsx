    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-forwards relative">
      ...
      <div>
        ...
        <p className="text-lg text-muted-foreground mt-2 font-medium">
          Welcome to <span className="text-primary">{institution.name}</span> student portal.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="glass p-6 rounded-3xl border border-border/50 shadow-sm relative group overflow-hidden">
          ...
          <h3 className="text-muted-foreground text-sm font-medium relative z-10 mb-2">Attendance</h3>
          <p className="text-4xl font-black relative z-10 tracking-tight text-foreground">85%</p>
        </div>
        <div className="glass p-6 rounded-3xl border border-border/50 shadow-sm relative group overflow-hidden">
          ...
          <h3 className="text-muted-foreground text-sm font-medium relative z-10 mb-2">GPA</h3>
          <p className="text-4xl font-black relative z-10 tracking-tight text-foreground">3.8</p>
        </div>
        <div className="glass p-6 rounded-3xl border border-border/50 shadow-sm relative group overflow-hidden">
          ...
          <h3 className="text-muted-foreground text-sm font-medium relative z-10 mb-2">Enrolled Courses</h3>
          <p className="text-4xl font-black relative z-10 tracking-tight text-foreground">6</p>
        </div>
        <div className="glass p-6 rounded-3xl border border-border/50 shadow-sm relative group overflow-hidden">
          ...
          <h3 className="text-muted-foreground text-sm font-medium relative z-10 mb-2">Pending Assignments</h3>
          <p className="text-4xl font-black relative z-10 tracking-tight text-foreground">3</p>
        </div>
      </div>
      ...
      <div className="glass rounded-3xl border border-border/50 p-8 mt-8 relative overflow-hidden">
        ...
        <h3 className="text-xl font-bold mb-4 relative z-10">Quick Links</h3>
        <div className="flex space-x-4 relative z-10">
          <button className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-sm font-bold shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5">View Timetable</button>
          <button className="px-5 py-2.5 bg-background hover:bg-accent border border-border/50 text-foreground rounded-xl text-sm font-bold shadow-sm hover:shadow-md transition-all">Download Transcript</button>
        </div>
      </div>
    </div>
  );
