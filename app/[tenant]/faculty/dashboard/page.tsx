    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-forwards relative">
      ...
      <div className="glass rounded-3xl border border-white/5 p-8 mt-8 relative overflow-hidden bg-black/40">
        ...
        <div className="flex space-x-4 relative z-10">
          <Link href={`/faculty/attendance`} className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-sm font-bold shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5">Take Attendance</Link>
