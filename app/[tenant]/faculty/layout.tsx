/**
 * Faculty Dashboard Shell Layout
 * Wraps all /[tenant]/faculty/* routes with sidebar + topbar.
 */
  ...
  return (
    <SidebarProvider>
      <div className="h-screen bg-background text-foreground flex overflow-hidden relative transition-colors duration-500">
        ...
        <Sidebar tenantId={institution.id} urlSlug={institution.slug} role="faculty" initialModules={modules} />
