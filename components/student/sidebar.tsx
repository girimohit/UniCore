          ...
          <div className="space-y-1">
            ...
            {studentLinks.map((item) => {
              ...
              return (
                ...
                >
                  <item.icon className={cn("h-5 w-5 transition-transform group-hover:scale-110", isActive ? "text-current" : "text-slate-400 group-hover:text-current")} />
                  {item.name}
                </Link>
              )
            })}
             ...
             <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div className="overflow-hidden">
                        <p className="text-sm font-bold text-slate-900 truncate">John Student</p>
