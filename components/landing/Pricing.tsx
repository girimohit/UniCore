...
const PLANS = [
  {
    name: "Starter",
    price: "Free",
    period: "for small institutions",
    desc: "Get started with core academic management modules at no cost.",
    features: [
      "Up to 200 students",
      "Departments & Courses",
  ...
  },
  {
    ...
    desc: "Full-featured suite with advanced scheduling and exam management.",
    features: [
      "Up to 2,500 students",
      "All Core + Optional modules",
      "Dynamic Timetable engine",
      "Exams & Result publishing",
      "Notices & Email Invitations",
    ],
  ...
  },
  {
    ...
    desc: "For large universities and multi-campus deployments with dedicated support.",
    features: [
      "Unlimited students",
